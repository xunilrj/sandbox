...
{
    let vb = createBuffer(device, await loadBuffer(vbFile || 'Boy01_LowerBody_GeoMesh.buffer'), GPUBufferUsage.VERTEX );
    let ib = createBuffer(device, await loadBuffer(ibFile || 'Boy01_LowerBody_GeoMesh.index'), GPUBufferUsage.INDEX );
    ...
    function render(canvas, device, backBufferView, depthTextureView, uniformBindGroups)
    {
        ...
        pass.drawIndexed(1470, 1, 0, 0, 0);
        pass.endPass();
        return commandEncoder.finish()
    }
    let boundingBox = {min:[-13.258233,30.192163,-6.388458],max:[13.258229,83.350452,9.462047],scale:[0.49882083300310887,1,0.29817560531340653]};
