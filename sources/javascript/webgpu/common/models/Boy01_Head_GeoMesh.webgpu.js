...
{
    let vb = createBuffer(device, await loadBuffer(vbFile || 'Boy01_Head_GeoMesh.buffer'), GPUBufferUsage.VERTEX );
    let ib = createBuffer(device, await loadBuffer(ibFile || 'Boy01_Head_GeoMesh.index'), GPUBufferUsage.INDEX );
    ...
    function render(canvas, device, backBufferView, depthTextureView, uniformBindGroups)
    {
        ...
        pass.drawIndexed(2694, 1, 0, 0, 0);
        pass.endPass();
        return commandEncoder.finish()
    }
    let boundingBox = {min:[-39.337509,136.812517,-25.128086],max:[37.646736,198.197009,36.641526],scale:[1,0.7973643438342483,0.8023669258560632]};
