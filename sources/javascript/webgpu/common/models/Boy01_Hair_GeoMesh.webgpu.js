...
{
    let vb = createBuffer(device, await loadBuffer(vbFile || 'Boy01_Hair_GeoMesh.buffer'), GPUBufferUsage.VERTEX );
    let ib = createBuffer(device, await loadBuffer(ibFile || 'Boy01_Hair_GeoMesh.index'), GPUBufferUsage.INDEX );
    ...
    function render(canvas, device, backBufferView, depthTextureView, uniformBindGroups)
    {
        ...
        pass.drawIndexed(2406, 1, 0, 0, 0);
        pass.endPass();
        return commandEncoder.finish()
    }
    let boundingBox = {min:[-42.973846,144.735232,-33.437625],max:[40.006489,211.590762,30.309597],scale:[1,0.805679200981775,0.7682208320802754]};
