/ \l C:\github\xunilrj-sandbox\sources\kdb\stat.q
\d .stat
u12:{-6f+sum x cut (12*x)?1f}

/ percentile
pctile:{[p;x]x iasc[x] -1+ceiling p*count
 x}
...
/ auto correlation
ac:{x%first x:x{(y#x)$neg[y]#x}/:c-tilc:count x-:avg x}
...
tnorminv:{
 a:0.0000003960315187 0.0000002888167364 0.0000321767881768 0.0003951896511919 0.0038405729373609 0.0276438810333863 0.1607979714918209 .9761690190917186 0.3374754822726147;
