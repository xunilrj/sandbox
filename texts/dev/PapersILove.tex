...
\begin{enumerate}
\item{A Universal Algorithm for Sequential Data Compression\\ \url{	http://citeseer.ist.psu.edu/viewdoc/download?doi=10.1.1.118.8921}}
...
\begin{enumerate}
	\item{Lists and why they are useful\\ \url{https://academic.oup.com/comjnl/article-pdf/7/4/278/1013051/7-4-278.pdf}}
	\item{Hashed and Hierarchical Timing Wheels: Data Structures for the Efficient Implementation of a Timer Facility\\ \url{https://web.archive.org/web/20130319034954/https://www.cs.columbia.edu/~nahum/w6998/papers/sosp87-timing-wheels.pdf}}
...
\url{http://graphics.idav.ucdavis.edu/education/GraphicsNotes/Bresenhams-Algorithm.pdf}}
	...
	\item{Pose Space Deformation: A Unified Approach to Shape Interpolation and
		Skeleton-Driven Deformation \\\url{http://scribblethink.org/Work/PSD/PSD.pdf}}
\end{enumerate}
...
\url{http://langvillea.people.cofc.edu/MCapps7.pdf}}
	\item{Linear Algebra for Computer Vision \\\url{http://buzzard.ups.edu/courses/2014spring/420projects/math420-UPS-spring-2014-wills-computer-vision.pdf}}
\end{enumerate}
