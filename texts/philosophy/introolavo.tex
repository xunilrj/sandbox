...
\begin{document}
	...
	É isso o que eu chamo ?intuicionismo radical?.?
	https://www.facebook.com/photo.php?fbid=10215093755150845&set=a.3036833753418&type=3&theater
	...
	https://www.facebook.com/olavo.decarvalho/posts/10156896956572192
	
	TRÊS ELEMENTOS DA FILOSOFIA POLÍTICA DE OLAVO DE CARVALHO
	https://www.youtube.com/watch?v=T2TLrnathAU&list=PL2wuZQFPMbL8e1QLKJZVKKoawroT-Lv3O
		
	Definição de agente histórico (agente político):
	Agente político é todo projeto que consegue se perpetuar no tempo dada alguma consistência. Uma pessoa obviamente pode ser um agente, mas tendo no máximo 50-60 anos de ação, mesmo que seja muito influente, como o Soros, um dia morrerá. E não tem um projeto para continuar o seu plano, a sua agência será forte, porém breve.
	
	Por conta disso o Estado-Nação não pode ser um agente, pois apesar de possuir a duração, não possui consistência necessária. Um dia está numa mão fazendo A, no outro está noutra mão fazendo B, ou até mesmo não-A (crítica direta ao Hans Morgenthal).
	
	O Olavo em si não cita, mas estudos interessantes aos agentes políticos reais e mais claros é feita pelo Antony Sutton. O que era considerado como Império America/Inglês-Atlântico e hoje é associado ao projeto do Cecil Rodhes, muito bem documento pelo Edward Griffin é um exemplo de uma agente político. Dos mais complexos, inclusive.
	
	MAIS SOBRE AGENTE HISTÓRICO
	
		Artigos do conceito "agente histórico"/"agente político" do Olavo de Carvalho.
		...
		(b) Ser capaz de prosseguir a consecução desses objetivos para além da duração de seus agentes individuais;
		(c) Ser, portanto, capaz de reproduzir agentes individuais aptos a prosseguir a ação ao longo dos séculos;
		...
		Diferença entre o agente histórico e filósofo/cientista.
		...
		Nenhuma dessas propostas veio do povo brasileiro ou de qualquer outro povo. Nenhuma delas tem a sua aprovação. Isso não importa. Elas vêm sendo e continuarão sendo impostas de cima para baixo, aqui como em outros países.
		...
		http://www.olavodecarvalho.org/conduzidos-a-forca/
		
		3 - Agente histórico do Eurasianismo do Dugin. Me parece a conclusão mais "arriscada" do Olavo. Hoje vejo o próprio Olavo dizendo como o Putin/Dugin mais usam a religião Russa do que o contrário.
		
		"Um exemplo de força histórica que transcende infinitamente as fronteiras e a duração de Estados e Impérios é a Igreja Ortodoxa, da qual o prof. Dugin se diz um crente. A força da Igreja Ortodoxa como agente histórico penetrou fundo no cérebro do próprio prof. Dugin, moldando a sua noção ?holista? do império teocrático. 
		
		[Dugin] qualifica de ?heresia? a distinção de Igreja e Império que moldou a civilização do Ocidente. Sem essa separação, a única hipótese que resta é de as fronteiras da expansão religiosa coincidirem milimetricamente com o mapa do Império.  Neste caso, a religião imperial torna-se apenas uma religião nacional ampliada.
		...
		Foi isso, de fato, o que aconteceu, enquanto a Igreja Ortodoxa, através do prof. Dugin, ainda está buscando uma saída para o mundo e não vê outro meio de encontrá-la senão constituir-se em Império Mundial."
		http://www.olavodecarvalho.org/debate-com-duguin-ii/
		
		Pequena nota sobre gerações:
		
		"De uma fase até a outra decorreram aproximadamente quinze anos ? o prazo que, em La Teoría Historica de las Generaciones, Julián Marías diz marcar o trânsito entre duas gerações de agentes históricos."
		http://www.olavodecarvalho.org/capitulos-de-historia-bestial/
	
	Marxismo como Cultura:
	Cultura = Sistema de Valores que estrutura o imaginado coletivo.
	Como subcultura vive como um parasita da cultura oficial.
	Horizonte de Consciência - Eric Voegelin
	
	Teoria da Mentalidade Revolucionária:
