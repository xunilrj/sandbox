...
#print('softmax[2.0] test_error=', run_softmax_on_MNIST(temp_parameter=2))
...
#print('softmax[1] mod 3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print('softmax PCA[1] test_error=', compute_test_error(test_pca, test_y, theta, 1))
...
print('softmax Cubic 10-PCA[1] test_error=', test_error)
